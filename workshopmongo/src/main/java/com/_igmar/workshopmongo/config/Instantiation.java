...
import com._igmar.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		CommentDTO com2 = new CommentDTO( "Aproveite",sdf.parse("23/03/2018"),new AuthorDTO(bob));
	...
	//    commentRepository.saveAll(Arrays.asList(com1,com3));
